...
int main()
{
    ...
    while (isRunning)
    {
        ...
        float firstNumber = ReadOperand("Enter first number or p: ", hasPR, PR);
        float secondNumber = ReadOperand("Enter second number or p: ", hasPR, PR);
        ...
        case '^':
            if (secondNumber != std::floor(secondNumber))
            {
